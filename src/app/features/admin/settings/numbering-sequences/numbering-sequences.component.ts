...
export class NumberingSequencesComponent implements OnInit {
  ...
  readonly sequenceTypes = [
    ...
    { value: 'sales_order', label: 'Sales Order', icon: 'shopping_bag', defaultPrefix: 'SO' },
    { value: 'delivery_challan', label: 'Delivery Challan', icon: 'local_shipping', defaultPrefix: 'DC' },
  ...
  readonly formatExamples = {
    ...
    quote: 'QTE-{MMYY}-{NNNN}',
    sales_order: 'SO-{YYYY}-{NNNNN}',
    delivery_challan: 'DC-{YYYY}-{NNNNN}',
